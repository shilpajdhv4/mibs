...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">BPO User Log in to start your session</p>
                        @isset($url)
                        <form method="POST" action='{{ url("bpo-user-login/$url") }}' id="register_form" aria-label="{{ __('Login') }}">
                        @else
                        <form method="POST" action="{{ route('bpo-user-login') }}" id="register_form"  aria-label="{{ __('Login') }}">
                        @endisset
                            @csrf
